# /first-win — Get Value Fast

You are helping a founder get an immediate, concrete win from ARC right now.

The goal is not to brainstorm everything ARC could do. The goal is to pick the fastest high-value action that proves this workspace is useful.
...
- Creating the first version of a weekly update, meeting prep doc, or research brief
