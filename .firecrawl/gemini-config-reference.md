...
[Feedback](https://github.com/google-gemini/gemini-cli/issues/new?template=website_issue.yml&url=https%3A%2F%2Fgeminicli.com%2Fdocs%2Freference%2Fconfiguration%2F) [GitHubGitHub](https://github.com/google-gemini/gemini-cli)
...
- [Introduction](https://geminicli.com/docs/reference/configuration/#_top)
- [Configuration layers](https://geminicli.com/docs/reference/configuration/#configuration-layers)
- [Settings files](https://geminicli.com/docs/reference/configuration/#settings-files)
  - [The .gemini directory in your project](https://geminicli.com/docs/reference/configuration/#the-gemini-directory-in-your-project)
  - [Available settings in settings.json](https://geminicli.com/docs/reference/configuration/#available-settings-in-settingsjson)
  - [Example settings.json](https://geminicli.com/docs/reference/configuration/#example-settingsjson)
- [Shell history](https://geminicli.com/docs/reference/configuration/#shell-history)
- [Environment variables and .env files](https://geminicli.com/docs/reference/configuration/#environment-variables-and-env-files)
  - [Environment variable redaction](https://geminicli.com/docs/reference/configuration/#environment-variable-redaction)
- [Command-line arguments](https://geminicli.com/docs/reference/configuration/#command-line-arguments)
- [Context files (hierarchical instructional context)](https://geminicli.com/docs/reference/configuration/#context-files-hierarchical-instructional-context)
  - [Example context file content (for example, GEMINI.md)](https://geminicli.com/docs/reference/configuration/#example-context-file-content-for-example-geminimd)
- [Sandboxing](https://geminicli.com/docs/reference/configuration/#sandboxing)
- [Usage statistics](https://geminicli.com/docs/reference/configuration/#usage-statistics)
