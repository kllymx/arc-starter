...
[Feedback](https://github.com/google-gemini/gemini-cli/issues/new?template=website_issue.yml&url=https%3A%2F%2Fgeminicli.com%2Fdocs%2Fcli%2Fsettings%2F) [GitHubGitHub](https://github.com/google-gemini/gemini-cli)
...
- [Introduction](https://geminicli.com/docs/cli/settings/#_top)
- [Settings reference](https://geminicli.com/docs/cli/settings/#settings-reference)
  - [General](https://geminicli.com/docs/cli/settings/#general)
  - [Output](https://geminicli.com/docs/cli/settings/#output)
  - [UI](https://geminicli.com/docs/cli/settings/#ui)
  - [IDE](https://geminicli.com/docs/cli/settings/#ide)
  - [Billing](https://geminicli.com/docs/cli/settings/#billing)
  - [Model](https://geminicli.com/docs/cli/settings/#model)
  - [Agents](https://geminicli.com/docs/cli/settings/#agents)
  - [Context](https://geminicli.com/docs/cli/settings/#context)
  - [Tools](https://geminicli.com/docs/cli/settings/#tools)
  - [Security](https://geminicli.com/docs/cli/settings/#security)
  - [Advanced](https://geminicli.com/docs/cli/settings/#advanced)
  - [Experimental](https://geminicli.com/docs/cli/settings/#experimental)
  - [Skills](https://geminicli.com/docs/cli/settings/#skills)
  - [HooksConfig](https://geminicli.com/docs/cli/settings/#hooksconfig)
