[Skip to Content](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#nextra-skip-nav)

[![Qwen Code](https://qwenlm.github.io/qwen-code-docs/favicon.png)QwenCode](https://qwenlm.github.io/qwen-code-docs/)

[User Guide](https://qwenlm.github.io/qwen-code-docs/en/users/overview/) [Developer Guide](https://qwenlm.github.io/qwen-code-docs/en/developers/architecture/) [Design](https://qwenlm.github.io/qwen-code-docs/en/design/adaptive-output-token-escalation/adaptive-output-token-escalation-design/) [Showcase](https://qwenlm.github.io/qwen-code-docs/en/showcase/) [Blog](https://qwenlm.github.io/qwen-code-docs/en/blog/)

`CTRL K`

 [25,484](https://github.com/QwenLM/qwen-code)
...
- User Guide
  ...
  - [Command Workflows](https://qwenlm.github.io/qwen-code-docs/en/users/common-workflow/)
  - Outside of the terminal
  - [Visual Studio Code](https://qwenlm.github.io/qwen-code-docs/en/users/integration-vscode/)
  - [Zed IDE](https://qwenlm.github.io/qwen-code-docs/en/users/integration-zed/)
  - [JetBrains IDEs](https://qwenlm.github.io/qwen-code-docs/en/users/integration-jetbrains/)
  - [Github Actions](https://qwenlm.github.io/qwen-code-docs/en/users/integration-github-action/)
  - Code with Qwen Code
  - Features


    - [Commands](https://qwenlm.github.io/qwen-code-docs/en/users/features/commands/)
    - [Code Review](https://qwenlm.github.io/qwen-code-docs/en/users/features/code-review/)
    - [Followup Suggestions](https://qwenlm.github.io/qwen-code-docs/en/users/features/followup-suggestions/)
    - [Tool-Use Summaries](https://qwenlm.github.io/qwen-code-docs/en/users/features/tool-use-summaries/)
    - [SubAgents](https://qwenlm.github.io/qwen-code-docs/en/users/features/sub-agents/)
    - [Agent Arena](https://qwenlm.github.io/qwen-code-docs/en/users/features/arena/)
    ...
    - [Dual Output](https://qwenlm.github.io/qwen-code-docs/en/users/features/dual-output/)
    ...
    - [LSP (Language Server Protocol)](https://qwenlm.github.io/qwen-code-docs/en/users/features/lsp/)
    ...
    - [i18n](https://qwenlm.github.io/qwen-code-docs/en/users/features/language/)
    - Channels


      - [Overview](https://qwenlm.github.io/qwen-code-docs/en/users/features/channels/overview/)
      - [Telegram](https://qwenlm.github.io/qwen-code-docs/en/users/features/channels/telegram/)
      - [WeChat](https://qwenlm.github.io/qwen-code-docs/en/users/features/channels/weixin/)
      - [DingTalk](https://qwenlm.github.io/qwen-code-docs/en/users/features/channels/dingtalk/)
      - [Plugins](https://qwenlm.github.io/qwen-code-docs/en/users/features/channels/plugins/)

    - [Hooks](https://qwenlm.github.io/qwen-code-docs/en/users/features/hooks/)
    - [Status Line](https://qwenlm.github.io/qwen-code-docs/en/users/features/status-line/)
    - [Scheduled Tasks](https://qwenlm.github.io/qwen-code-docs/en/users/features/scheduled-tasks/)
    - [Contextual Tips](https://qwenlm.github.io/qwen-code-docs/en/users/features/tips/)
  ...
  - Configuration
    ...
    - [Ignoring Files](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/qwen-ignore/)
    - [Trusted Folders](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/trusted-folders/)
    - [Themes](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/themes/)
    - [Model Providers](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/model-providers/)

  - Extension


    - [Introduction](https://qwenlm.github.io/qwen-code-docs/en/users/extension/introduction/)

  - Reference


    - [Keyboard Shortcuts](https://qwenlm.github.io/qwen-code-docs/en/users/reference/keyboard-shortcuts/)

  - Support


    - [Troubleshooting](https://qwenlm.github.io/qwen-code-docs/en/users/support/troubleshooting/)
    - [Terms of Service](https://qwenlm.github.io/qwen-code-docs/en/users/support/tos-privacy/)
    - [Uninstall](https://qwenlm.github.io/qwen-code-docs/en/users/support/Uninstall/)
...
- Developer Guide
  ...
  - [Roadmap](https://qwenlm.github.io/qwen-code-docs/en/developers/roadmap/)
  - [Contributing Guide](https://qwenlm.github.io/qwen-code-docs/en/developers/contributing/)
  - Agent SDK
  - [Typescript SDK](https://qwenlm.github.io/qwen-code-docs/en/developers/sdk-typescript/)
  - [Python SDK (alpha)](https://qwenlm.github.io/qwen-code-docs/en/developers/sdk-python/)
  - [Java SDK (alpha)](https://qwenlm.github.io/qwen-code-docs/en/developers/sdk-java/)
  - Dive Into Qwen Code
  - [Channel Plugin Guide](https://qwenlm.github.io/qwen-code-docs/en/developers/channel-plugins/)
  - Tools


    - [Introduction](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/introduction/)
    - [File System](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/file-system/)
    - [Multi-File Read](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/multi-file/)
    - [Shell](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/shell/)
    - [Todo Write](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/todo-write/)
    - [Task](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/task/)
    - [Exit Plan Mode](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/exit-plan-mode/)
    - [Web Fetch](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/web-fetch/)
    - [Web Search](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/web-search/)
    - [MCP Servers](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/mcp-server/)
    - [Sandboxing](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/sandbox/)
    - [Memory Tool (save\_memory)](https://qwenlm.github.io/qwen-code-docs/en/developers/tools/memory/)

  - Development


    - [NPM](https://qwenlm.github.io/qwen-code-docs/en/developers/development/npm/)
    - [Telemetry](https://qwenlm.github.io/qwen-code-docs/en/developers/development/telemetry/)
    - [Integration Tests](https://qwenlm.github.io/qwen-code-docs/en/developers/development/integration-tests/)
    - [Issue and PR Automation](https://qwenlm.github.io/qwen-code-docs/en/developers/development/issue-and-pr-automation/)

  - Extensions


    - [Qwen Code Extensions](https://qwenlm.github.io/qwen-code-docs/en/developers/extensions/extension/)
    - [Extension Releasing](https://qwenlm.github.io/qwen-code-docs/en/developers/extensions/extension-releasing/)
...
- Design
  ...
  - Adaptive Output Token Escalation
    ...
    - [Adaptive Output Token Escalation Design](https://qwenlm.github.io/qwen-code-docs/en/design/adaptive-output-token-escalation/adaptive-output-token-escalation-design/)

  - Auto Memory


    - [Memory 记忆管理系统](https://qwenlm.github.io/qwen-code-docs/en/design/auto-memory/memory-system/)

  - Channels


    - [Channels Design](https://qwenlm.github.io/qwen-code-docs/en/design/channels/channels-design/)

  - Compact Mode


    - [Compact Mode Design: Competitive Analysis & Optimization](https://qwenlm.github.io/qwen-code-docs/en/design/compact-mode/compact-mode-design/)

  - Fork Subagent


    - [Fork Subagent Design](https://qwenlm.github.io/qwen-code-docs/en/design/fork-subagent/fork-subagent-design/)

  - [OpenRouter Auth and Model Management Design](https://qwenlm.github.io/qwen-code-docs/en/design/openrouter-auth-and-models/)
  - Prompt Suggestion


    - [Prompt Suggestion (NES) Design](https://qwenlm.github.io/qwen-code-docs/en/design/prompt-suggestion/prompt-suggestion-design/)
    - [Prompt Suggestion Implementation Status](https://qwenlm.github.io/qwen-code-docs/en/design/prompt-suggestion/prompt-suggestion-implementation/)
    - [Speculation Engine Design](https://qwenlm.github.io/qwen-code-docs/en/design/prompt-suggestion/speculation-design/)

  - Session Recap


    - [Session Recap Design](https://qwenlm.github.io/qwen-code-docs/en/design/session-recap/session-recap-design/)

  - Session Title


    - [Session Title Design](https://qwenlm.github.io/qwen-code-docs/en/design/session-title/session-title-design/)

  - Slash Command


    - [Qwen Code Command 模块重构方案](https://qwenlm.github.io/qwen-code-docs/en/design/slash-command/compare/)
    - [Phase 1 技术设计文档：基础设施重建](https://qwenlm.github.io/qwen-code-docs/en/design/slash-command/phase1-technical-design/)
    - [Phase 2 技术设计文档：能力扩展](https://qwenlm.github.io/qwen-code-docs/en/design/slash-command/phase2-technical-design/)
    - [Slash Command 重构路线图](https://qwenlm.github.io/qwen-code-docs/en/design/slash-command/roadmap/)

  - Tool Use Summary


    - [Tool-Use Summary Design](https://qwenlm.github.io/qwen-code-docs/en/design/tool-use-summary/tool-use-summary-design/)

- [Showcase](https://qwenlm.github.io/qwen-code-docs/en/showcase/)
- Blog


  - [Qwen Code Blog: AI Coding Updates and Guides](https://qwenlm.github.io/qwen-code-docs/en/blog/)
  - [Qwen Code Beta: Use AI to Write Code in Your WeChat Channel!](https://qwenlm.github.io/qwen-code-docs/en/blog/channels-weixin-launch-announcement/)
  - [One Sentence: Create a Blockbuster Promotional Video for Your Open Source Project](https://qwenlm.github.io/qwen-code-docs/en/blog/feat-skills-oss-styles/)
  - [I Used AI to Clean Up My Chaotic Desktop: Complete Guide to Qwen Code Cowork Use Cases](https://qwenlm.github.io/qwen-code-docs/en/blog/how-to-use-qwencode-cowork/)
  - [Turns Out AI Knows Me Better Than I Know Myself—Experiencing Qwen Code Insight](https://qwenlm.github.io/qwen-code-docs/en/blog/how-to-use-qwencode-insight/)
  - [Qwen Code + Obsidian: Making Knowledge Management Accessible](https://qwenlm.github.io/qwen-code-docs/en/blog/obsidian/)
  - [Generate Images with One Prompt, Product Photos from Your Phone, AI Copywriting Published to WeChat — E-commerce Marketing with Qwen Code](https://qwenlm.github.io/qwen-code-docs/en/blog/qwencode-bailian-ai-marketing/)
  - [Finish Homework, Portfolio, and Open Source Projects in 10 Minutes - Qwen Code + Coding Plan Practice](https://qwenlm.github.io/qwen-code-docs/en/blog/qwencode-coding-plan-guide-build-website/)
  - [A Letter to University Students: 10 Real Use Cases for Qwen Code](https://qwenlm.github.io/qwen-code-docs/en/blog/qwencode-for-university-students/)
  - [One Prompt to Generate Covers: I Built an AI Cover Generation Skill with 4 Styles for WeChat Official Accounts](https://qwenlm.github.io/qwen-code-docs/en/blog/qwencode-mpcover-skill-guide/)
  - [Announcing Qwen Code: An AI Coding Agent That Thinks Like a Programmer](https://qwenlm.github.io/qwen-code-docs/en/blog/thinks-like-a-programmer/)
  - [Qwen Code Weekly: LSP Support, Batch Runner, New Languages](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-02-03/)
  - [Qwen Code Weekly: Agent Skills GA, One-Click Install, Session Export](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-02-09/)
  - [Qwen Code Weekly: Insight Analytics, Clipboard Images, Terminal Capture](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-03-03/)
  - [Qwen Code Weekly: HTML Export Enhancement, Terminal GIF Recording, GitHub Workflow Commands](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-03-06/)
  - [Qwen Code Weekly: Automated Workflows, Better Extension & MCP Management, VS Code Sidebar](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-03-13/)
  - [Qwen Code Weekly: Token Limit Doubled, Real-time Usage Display, JetBrains Editor Support](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-03-20/)
  - [Qwen Code Weekly: AI Code Review, Ask Questions Without Losing Context, Custom Workflow Automation](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-03-27/)
  - [Qwen Code Weekly: Channels Multi-Platform Access, Cron Scheduled Tasks, /plan Planning Mode, Qwen 3.6 Plus Launch](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-04-09/)
  - [Qwen Code Weekly: Smart Tool Parallelism, Fork Sub-Agent Context Sharing, CJK Word Segmentation](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-04-16/)
  ...
  - [Qwen Code Weekly: DeepSeek V4 gets a 1M context window, plus background tasks and conversation rewind](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-05-07/)
  - [Qwen Code Weekly: VSCode message rewind, /export light/dark toggle, ToolSearch saves tokens on demand](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-05-14/)
  - [Qwen Code Weekly: /goal autonomous coding, Auto Approval hands-free, Worktree isolation](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-05-21/)
  ...
  - [Qwen Code Weekly: Zero-Config Built-in Computer Use, Feishu Integration, Compression Engine Rewrite](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-06-04/)
  - [Qwen Code Weekly: /fork Background Agents, /skills Management Panel, Cross-Project Memory](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-06-11/)
  - [Qwen Code Weekly: Agent Team Parallel Collaboration, Durable /loop Survives Restart, /cd Switch Directory](https://qwenlm.github.io/qwen-code-docs/en/blog/weekly-update-2026-06-18/)

- Plans


  - [Agent Tool Display Implementation Plan](https://qwenlm.github.io/qwen-code-docs/en/plans/2026-03-22-agent-tool-display-design/)
...
- [Configuration layers](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#configuration-layers)
- [Settings files](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#settings-files)
- [The `.qwen` directory in your project](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#the-qwen-directory-in-your-project)
- [Configuration migration](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#configuration-migration)
- [Consolidation policy for `disableAutoUpdate` and `disableUpdateNag`](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#consolidation-policy-for-disableautoupdate-and-disableupdatenag)
- [Available settings in `settings.json`](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#available-settings-in-settingsjson)
- [top-level](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#top-level)
- [general](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#general)
- [output](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#output)
- [ui](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#ui)
- [ide](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#ide)
- [privacy](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#privacy)
- [model](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#model)
- [fastModel](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#fastmodel)
- [context](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#context)
- [Troubleshooting File Search Performance](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#troubleshooting-file-search-performance)
- [tools](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#tools)
- [memory](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#memory)
- [permissions](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#permissions)
- [slashCommands](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#slashcommands)
- [mcp](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#mcp)
- [lsp](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#lsp)
- [security](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#security)
- [advanced](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#advanced)
- [mcpServers](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#mcpservers)
- [telemetry](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#telemetry)
- [Example `settings.json`](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#example-settingsjson)
- [Shell History](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#shell-history)
- [Environment Variables & `.env` Files](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#environment-variables--env-files)
- [Environment Variables Table](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#environment-variables-table)
- [Command-Line Arguments](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#command-line-arguments)
- [Command-Line Arguments Table](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#command-line-arguments-table)
- [Context Files (Hierarchical Instructional Context)](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#context-files-hierarchical-instructional-context)
- [Example Context File Content (e.g. `QWEN.md`)](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#example-context-file-content-eg-qwenmd)
- [Sandbox](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#sandbox)
- [Usage Statistics](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/#usage-statistics)

[Question? Give us feedback](https://github.com/QwenLM/qwen-code/issues/new?title=Feedback%20for%20%E2%80%9CQwen%20Code%20Configuration%E2%80%9D&labels=feedback) [Edit this page](https://github.com/QwenLM/qwen-code/blob/main/docs/content/en/users/configuration/settings.md) Scroll to top
...
**Authentication / API keys:** Authentication (API Key, Alibaba Cloud Coding Plan) and auth-related environment variables (like `OPENAI_API_KEY`) are documented in **[Authentication](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/auth/)**.
...
## Configuration layers [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#configuration-layers)
...
## Settings files [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#settings-files)
...
### The `.qwen` directory in your project [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#the-qwen-directory-in-your-project)
...
- [Custom sandbox profiles](https://qwenlm.github.io/qwen-code-docs/en/users/features/sandbox/) (e.g. `.qwen/sandbox-macos-custom.sb`, `.qwen/sandbox.Dockerfile`).
- [Agent Skills](https://qwenlm.github.io/qwen-code-docs/en/users/features/skills/) under `.qwen/skills/` (each Skill is a directory containing a `SKILL.md`).

### Configuration migration [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#configuration-migration)
...
#### Consolidation policy for `disableAutoUpdate` and `disableUpdateNag` [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#consolidation-policy-for-disableautoupdate-and-disableupdatenag)
...
### Available settings in `settings.json` [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#available-settings-in-settingsjson)
...
#### top-level [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#top-level)
...
#### general [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#general)
...
#### output [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#output)

| Setting | Type | Description | Default | Possible Values |
| --- | --- | --- | --- | --- |
| `output.format` | string | The format of the CLI output. | `"text"` | `"text"`, `"json"` |

#### ui [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#ui)

| Setting | Type | Description | Default |
| --- | --- | --- | --- |
| `ui.theme` | string | The color theme for the UI. See [Themes](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/themes/) for available options. | `undefined` |
| `ui.customThemes` | object | Custom theme definitions. | `{}` |
| `ui.statusLine` | object | Custom status line configuration. A shell command whose output is shown in the footer’s left section. See [Status Line](https://qwenlm.github.io/qwen-code-docs/en/users/features/status-line/). | `undefined` |
| `ui.hideWindowTitle` | boolean | Hide the window title bar. | `false` |
| `ui.hideTips` | boolean | Hide all tips (startup and post-response) in the UI. See [Contextual Tips](https://qwenlm.github.io/qwen-code-docs/en/users/features/tips/). | `false` |
...
| `ui.enableFollowupSuggestions` | boolean | Enable [followup suggestions](https://qwenlm.github.io/qwen-code-docs/en/users/features/followup-suggestions/) that predict what you want to type next after the model responds. Suggestions appear as ghost text and can be accepted with Tab, Enter, or Right Arrow. | `true` |
...
| `experimental.emitToolUseSummaries` | boolean | Generate short LLM-based labels summarizing each tool-call batch. See [Tool-Use Summaries](https://qwenlm.github.io/qwen-code-docs/en/users/features/tool-use-summaries/). Requires `fastModel` to be configured; silently skipped otherwise. Can be overridden per-session with `QWEN_CODE_EMIT_TOOL_USE_SUMMARIES=0` or `=1`. | `true` |

#### ide [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#ide)
...
**max\_tokens (adaptive output tokens):**
...
#### fastModel [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#fastmodel)

| Setting | Type | Description | Default |
| --- | --- | --- | --- |
| `fastModel` | string | Model used for generating [prompt suggestions](https://qwenlm.github.io/qwen-code-docs/en/users/features/followup-suggestions/) and speculative execution. Leave empty to use the main model. A smaller/faster model (e.g., `qwen3-coder-flash`) reduces latency and cost. Can also be set via `/model --fast`. | `""` |

#### context [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#context)
...
#### Troubleshooting File Search Performance [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#troubleshooting-file-search-performance)
...
#### tools [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#tools)
...
#### memory [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#memory)
...
See [Memory](https://qwenlm.github.io/qwen-code-docs/en/users/features/memory/) for details on how auto-memory works and how to use the `/memory`, `/remember`, and `/dream` commands.

#### permissions [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#permissions)
...
#### slashCommands [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#slashcommands)
...
#### mcp [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#mcp)
...
#### lsp [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#lsp)
...
LSP server configuration is done through `.lsp.json` files in your project root directory, not through `settings.json`. See the [LSP documentation](https://qwenlm.github.io/qwen-code-docs/en/users/features/lsp/) for configuration details and examples.

#### security [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#security)
...
#### advanced [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#advanced)
...
#### mcpServers [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#mcpservers)
...
#### telemetry [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#telemetry)

Configures logging and metrics collection for Qwen Code. For more information, see [telemetry](https://qwenlm.github.io/qwen-code-docs/en/developers/development/telemetry/).
...
### Example `settings.json` [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#example-settingsjson)
...
## Shell History [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#shell-history)
...
## Environment Variables & `.env` Files [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#environment-variables--env-files)
...
For authentication-related variables (like `OPENAI_*`) and the recommended `.qwen/.env` approach, see **[Authentication](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/auth/)**.
...
### Environment Variables Table [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#environment-variables-table)
...
## Command-Line Arguments [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#command-line-arguments)
...
### Command-Line Arguments Table [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#command-line-arguments-table)
...
| `--append-system-prompt` |  | Appends extra instructions to the main session system prompt for this run. | Your prompt text | Applied after the built-in prompt and loaded context files. Can be combined with `--system-prompt`. See [Headless Mode](https://qwenlm.github.io/qwen-code-docs/en/users/features/headless/) for examples. |
...
| `--input-format` |  | Specifies the format consumed from standard input. | `text`, `stream-json` | `text`: (Default) Standard text input from stdin or command-line arguments. `stream-json`: JSON message protocol via stdin for bidirectional communication. Requirement: `--input-format stream-json` requires `--output-format stream-json` to be set. When using `stream-json`, stdin is reserved for protocol messages. See [Headless Mode](https://qwenlm.github.io/qwen-code-docs/en/users/features/headless/) for detailed information. |
| `--include-partial-messages` |  | Include partial assistant messages when using `stream-json` output format. When enabled, emits stream events (message\_start, content\_block\_delta, etc.) as they occur during streaming. |  | Default: `false`. Requirement: Requires `--output-format stream-json` to be set. See [Headless Mode](https://qwenlm.github.io/qwen-code-docs/en/users/features/headless/) for detailed information about stream events. |
...
| `--approval-mode` |  | Sets the approval mode for tool calls. | `plan`, `default`, `auto-edit`, `yolo` | Supported modes: `plan`: Analyze only—do not modify files or execute commands. `default`: Require approval for file edits or shell commands (default behavior). `auto-edit`: Automatically approve edit tools (edit, write\_file) while prompting for others. `yolo`: Automatically approve all tool calls (equivalent to `--yolo`). Cannot be used together with `--yolo`. Use `--approval-mode=yolo` instead of `--yolo` for the new unified approach. Example: `qwen --approval-mode auto-edit`<br>See more about [Approval Mode](https://qwenlm.github.io/qwen-code-docs/en/users/features/approval-mode/). |
...
| `--telemetry` |  | Enables [telemetry](https://qwenlm.github.io/qwen-code-docs/en/developers/development/telemetry/). |  |  |
| `--telemetry-target` |  | Sets the telemetry target. |  | See [telemetry](https://qwenlm.github.io/qwen-code-docs/en/developers/development/telemetry/) for more information. |
| `--telemetry-otlp-endpoint` |  | Sets the OTLP endpoint for telemetry. |  | See [telemetry](https://qwenlm.github.io/qwen-code-docs/en/developers/development/telemetry/) for more information. |
| `--telemetry-otlp-protocol` |  | Sets the OTLP protocol for telemetry (`grpc` or `http`). |  | Defaults to `grpc`. See [telemetry](https://qwenlm.github.io/qwen-code-docs/en/developers/development/telemetry/) for more information. |
| `--telemetry-log-prompts` |  | Enables logging of prompts for telemetry. |  | See [telemetry](https://qwenlm.github.io/qwen-code-docs/en/developers/development/telemetry/) for more information. |
| `--checkpointing` |  | Enables [checkpointing](https://qwenlm.github.io/qwen-code-docs/en/users/features/checkpointing/). |  |  |
| `--acp` |  | Enables ACP mode (Agent Client Protocol). Useful for IDE/editor integrations like [Zed](https://qwenlm.github.io/qwen-code-docs/en/users/integration-zed/). |  | Stable. Replaces the deprecated `--experimental-acp` flag. |
| `--experimental-lsp` |  | Enables experimental [LSP (Language Server Protocol)](https://qwenlm.github.io/qwen-code-docs/en/users/features/lsp/) feature for code intelligence (go-to-definition, find references, diagnostics, etc.). |  | Experimental. Requires language servers to be installed. |
...
## Context Files (Hierarchical Instructional Context) [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#context-files-hierarchical-instructional-context)
...
### Example Context File Content (e.g. `QWEN.md`) [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#example-context-file-content-eg-qwenmd)
...
- **Importing Content:** You can modularize your context files by importing other Markdown files using the `@path/to/file.md` syntax. For more details, see the [Memory Import Processor documentation](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/memory/).
- **Commands for Memory Management:**
  - Use `/memory refresh` to force a re-scan and reload of all context files from all configured locations. This updates the AI’s instructional context.
  - Use `/memory show` to display the combined instructional context currently loaded, allowing you to verify the hierarchy and content being used by the AI.
  - See the [Commands documentation](https://qwenlm.github.io/qwen-code-docs/en/users/features/commands/) for full details on the `/memory` command and its sub-commands (`show` and `refresh`).
...
## Sandbox [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#sandbox)
...
[Sandbox](https://qwenlm.github.io/qwen-code-docs/en/users/features/sandbox/) is disabled by default, but you can enable it in a few ways:
...
## Usage Statistics [Permalink for this section](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/settings/\#usage-statistics)
...
Last updated onMay 6, 2026

[Contextual Tips](https://qwenlm.github.io/qwen-code-docs/en/users/features/tips/ "Contextual Tips") [Authentication](https://qwenlm.github.io/qwen-code-docs/en/users/configuration/auth/ "Authentication")